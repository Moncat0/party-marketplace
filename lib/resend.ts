...
export async function sendBookingAccepted(
  ...
  await resend.emails.send({
    ...
    html: `
      ...
      <p><a href="${siteUrl()}/planner/bookings" style="background:#FF2E8A;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:600;display:inline-block;">Betala ${priceSek} kr →</a></p>
      ` : `
