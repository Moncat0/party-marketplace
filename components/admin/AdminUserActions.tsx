...
export default function AdminUserActions({
  ...
  const [subject, setSubject] = useState('Meddelande från FESTEN.')
      ...
      <Dialog open={messageOpen} onOpenChange={setMessageOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Skickas som e-post från FESTEN. support. Svar går till din admin-adress.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Hej! Vi hör av oss från FESTEN…"
              />
            </div>
            {sent ? (
