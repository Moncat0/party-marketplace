    ...
    <main className="min-h-screen bg-[#FFF8F3] px-4 py-10">
      <div className="mx-auto max-w-sm">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-2xl font-bold text-[#1A1A2E]">Integritetspolicy</h1>
        ...
        <div className="space-y-6 text-sm text-[#1A1A2E] leading-relaxed">
          ...
          <section>
            ...
            <p className="text-[#5F5E5A]">FESTEN. är en tjänst för att hitta och boka underhållning till evenemang i Stockholm. Vi värnar om din integritet och behandlar dina personuppgifter i enlighet med GDPR (EU:s dataskyddsförordning).</p>
          </section>
          ...
          <section>
            ...
            <p className="text-[#5F5E5A]">Vi sparar dina uppgifter så länge ditt konto är aktivt. Om du avslutar ditt konto raderar vi dina personuppgifter inom 30 dagar.</p>
          </section>

          <section>
            <h2 className="font-semibold mb-2">Dina rättigheter</h2>
            <p className="text-[#5F5E5A] mb-2">Enligt GDPR har du rätt att:</p>
            <ul className="text-[#5F5E5A] space-y-1 list-disc list-inside">
          ...
          <section>
            ...
            <p className="text-[#5F5E5A]">Vi använder PostHog för analys av hur tjänsten används. Cookies sätts bara om du godkänner det via vår cookie-banner. Du kan när som helst ändra dina inställningar.</p>
          </section>

          <section>
            <h2 className="font-semibold mb-2">Tredjepartsleverantörer</h2>
            <p className="text-[#5F5E5A]">Vi använder Supabase (databas och autentisering) och Resend (e-post). Dessa leverantörer hanterar data i enlighet med GDPR.</p>
          </section>

          <section>
            <h2 className="font-semibold mb-2">Kontakta oss</h2>
            <p className="text-[#5F5E5A]">Har du frågor om hur vi hanterar dina uppgifter? Kontakta oss på <a href="mailto:hej@festen.se" className="text-[#FF6B35] hover:underline">hej@festen.se</a></p>
          </section>
