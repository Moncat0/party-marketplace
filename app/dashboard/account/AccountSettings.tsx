      ...
      <div className="rounded-2xl bg-white border border-[#EBEBEB] p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-[#A0A0A0] mt-1.5">Syns bara för planerare som har en aktiv bokning med dig.</p>
          </div>
        </div>
        <Msg msg={profileMsg} />
      ...
      <div className="rounded-2xl bg-white border border-[#EBEBEB] p-6">
        ...
        <div className="mb-5 rounded-xl bg-[#F7F7F7] border border-[#EBEBEB] px-4 py-4">
          ...
          <ul className="space-y-1 text-xs text-[#717171]">
            <li>✓ Ny bokningsförfrågan från en planerare</li>
            <li>✓ Nya meddelanden i en konversation</li>
