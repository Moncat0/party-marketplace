...
description: >-
  Gigtorget marketing website design system — pink/orange/cream/ink, Anton /
...
4. [`design system/uploads/gigtorget-tone-of-voice-guide-sv.md`](../../../design%20system/uploads/gigtorget-tone-of-voice-guide-sv.md) — Swedish voice (source)
...
- App chrome already uses Gigtorget **colors** (pink primary, white canvas) via `app/globals.css`.
- **Do not** pull Anton/Caveat or cream page backgrounds into app tool chrome.
- **Do not** use Airbnb Rausch `#FF385C` — use Gigtorget pink.
